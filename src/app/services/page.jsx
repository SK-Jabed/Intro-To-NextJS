...
const page = () => {
  ...
  return (
    <div className="my-14">
      <h2 className="font-semibold text-3xl text-center mb-2">All Available Services</h2>
      <p className="text-center text-gray-500 mb-6">Explore our all available services and take a bow!</p>
